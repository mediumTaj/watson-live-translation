...
namespace LangaugeTranslatorDemo
{
    public class SpeechToTextSample : MonoBehaviour
    {
        ...
        [Header("Parameters")]
        // https://cloud.ibm.com/apidocs/speech-to-text#list-models
        [Tooltip("The Model to use. This defaults to en-US_BroadbandModel. See https://cloud.ibm.com/apidocs/speech-to-text#list-models.")]
        [SerializeField]
        private string recognizeModel;

        //  Reference to LanguateTranslatorSample - Set in the Inspector
        [SerializeField]
        private LanguageTranslatorSample languageTranslatorSample;
        #endregion
        ...
        public bool Active
        {
            ...
            set
            {
                ...
                {
                    _service.RecognizeModel = (string.IsNullOrEmpty(recognizeModel) ? "en-US_BroadbandModel" : recognizeModel);
            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        //  Uncomment if you only want final results
                        //if (res.final)
                        //{
                        //  Send the results from SpeechToText to LanguageTranslatorSample
